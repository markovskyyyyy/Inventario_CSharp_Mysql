...
namespace Sol_Almacen.Presentacion
{
    ...
    {
        public System.Data.DataTable Listado_ar(string cTexto)
        {
            ...
            try
            {
                ...
                if (nOpcion == 1)
                {
                    Sqltarea = "Insert into tb_articulos(descripcion_ar, " +
                        ...
                        "'" + oAr.Codigo_um + "', " +
                        "'" + oAr.Codigo_ca + "', " +
                        "'" + oAr.Stock_actual.ToString(System.Globalization.CultureInfo.InvariantCulture) + "', " +
                        "'" + oAr.Fecha_crea + "', " +
                ...
                else
                {
                    Sqltarea = "update tb_articulos set descripcion_ar='" + oAr.Descripcion_ar + "'," +
                        ...
                        "stock_actual='" + oAr.Stock_actual.ToString(System.Globalization.CultureInfo.InvariantCulture) + "'," +
        ...
        public System.Data.DataTable Listado_um()
        {
            MySqlDataReader Resultado;
            DataTable Tabla = new DataTable();
            MySqlConnection SqlCon = new MySqlConnection();
        ...
        public System.Data.DataTable Listado_ca()
        {
            MySqlDataReader Resultado;
            DataTable Tabla = new DataTable();
            MySqlConnection SqlCon = new MySqlConnection();
